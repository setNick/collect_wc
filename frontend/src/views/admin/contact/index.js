...
const Index = () => {
    const columns = [
        ...
        { Header: 'Абонент', accessor: 'title' },
        { Header: "Текущие показания", accessor: "firstName", },
        // { Header: "last Name", accessor: "lastName", },
        // { Header: "phone Number", accessor: "phoneNumber", },
        // { Header: "Email Address", accessor: "email", },
        // { Header: "physical Address", accessor: "physicalAddress", },
        { Header: "mailing Address", accessor: "mailingAddress", },
        { Header: "Контакты", accessor: "preferredContactMethod", },
    ];
        ...
        <div>
            <Grid templateColumns="repeat(6, 1fr)" mb={3} gap={1}>
                <GridItem colStart={6} textAlign={"right"}>
                    <Button onClick={() => handleClick()} leftIcon={<AddIcon />} variant="brand">Добавить</Button>
                </GridItem>
            </Grid>
